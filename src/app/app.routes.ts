...
@NgModule({
  declarations:[],
  imports: [RouterModule.forRoot(routes), DailyProductsComponent, HttpClientModule, ToastrModule.forRoot({timeOut:3000, positionClass:'toast-bottom-right', newestOnTop:false}), BrowserAnimationsModule, BrowserModule],
